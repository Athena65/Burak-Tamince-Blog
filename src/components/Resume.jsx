const Resume = () => {
  return (
    <section id="resume" className="resume section relative overflow-hidden rounded-lg border border-white/5 bg-black/85 py-16 shadow-[0_8px_32px_rgba(0,0,0,0.1)] backdrop-blur-[5px]">
